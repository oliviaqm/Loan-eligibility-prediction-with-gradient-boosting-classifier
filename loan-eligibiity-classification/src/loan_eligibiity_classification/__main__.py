"""loan-eligibiity-classification file for ensuring the package is executable
as `loan-eligibiity-classification` and `python -m loan_eligibiity_classification`
"""
import importlib
